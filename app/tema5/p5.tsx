...
const question = {
  text: 'Se realiza todo el proceso de ordenamiento en memoria. Son adecuados cuando los datos caben en la memoria RAM.',
  options: [
    { label: 'A) Ordenamiento Interno', correct: true },
    { label: 'B) Ordenamiento Externo', correct: false },
  ],
};

export default function PreguntaCincoScreen() {
      ...
      <ScrollView contentContainerStyle={styles.scrollContent} showsVerticalScrollIndicator={false}>
        ...
        {isCorrect === false && (
          <View style={styles.feedbackBoxError}>
            <Text style={styles.feedbackTextError}>❌ Incorrecto. Piensa en el lugar donde se guardan los datos.</Text>
          </View>
        )}
