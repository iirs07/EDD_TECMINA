...
const question = {
  text: '¿Cuál es la principal ventaja de una lista doblemente enlazada respecto a una lista enlazada simple?',
  options: [
    { label: 'A) Permite recorrerla en ambas direcciones', correct: true },
    { label: 'B) Consume menos memoria', correct: false },
    { label: 'C) Es más eficiente para insertar elementos al final', correct: false },
  ],
};

export default function PreguntaListasScreen() {
  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      <View style={styles.blueBar}>
        ...
        <Text style={styles.barTitle}>🧠 Ejercicio 7 </Text>
      </View>
      ...
      >
        ...
        <View style={[styles.optionsContainer, { marginTop: height * 0.03 }]}>
          {question.options.map((option, index) => {
            ...
            // Colores sólidos para evitar la mancha blanca/gris nativa
        ...
        <View style={styles.feedbackContainer}>
          ...
          {isCorrect && (
            <TouchableOpacity
              ...
              onPress={() => router.push('/tema3/veinteuno')}
            >
