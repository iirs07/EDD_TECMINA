...
const question = {
  text: '¿Cuál de las siguientes afirmaciones es correcta sobre una lista basada en array?',
  options: [
    { label: 'A) Es eficiente al agregar o eliminar elementos en el medio', correct: false },
    { label: 'B) Permite recorrerla indefinidamente en ambas direcciones', correct: false },
    { label: 'C) Es eficiente en términos de acceso a elementos por índice', correct: true },
  ],
};

export default function Ejercicio8Screen() {
  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      <View style={styles.blueBar}>
        ...
        <Text style={styles.barTitle}>🧠 Ejercicio 8</Text>
      </View>
      ...
      >
        ...
        {/* Feedback y Botón Finalizar */}
        <View style={styles.feedbackContainer}>
          {isCorrect === false && (
            <Text style={styles.feedbackText}>❌ Incorrecto. Revisa el concepto de arreglos e intenta de nuevo.</Text>
          )}
