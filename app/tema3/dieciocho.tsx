...
const question = {
  text: '¿Qué estructura de datos sigue el principio LIFO (Last In, First Out): el último elemento en ser insertado es el primero en ser eliminado?',
  options: [
    { label: 'A) Pila', correct: true },
    { label: 'B) Lista enlazada', correct: false },
    { label: 'C) Cola', correct: false },
  ],
};
  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      <View style={styles.blueBar}>
        ...
        <Text style={styles.barTitle}>🧠 Ejercicio 5</Text>
      </View>
      ...
      >
        {/* Pregunta con margen responsivo */}
        ...
        <View style={[styles.optionsContainer, { marginTop: height * 0.03 }]}>
          {question.options.map((option, index) => {
            ...
            // Definimos colores de fondo limpios según selección
            ...
            return (
              <TouchableOpacity
                key={index}
                // activeOpacity={1} y underlayColor transparent eliminan la "sombra blanca"
                activeOpacity={0.8}
                style={[
                  styles.option,
                  { 
        ...
        <View style={styles.feedbackContainer}>
          ...
          {isCorrect && (
            <TouchableOpacity
              ...
              onPress={() => router.push('/tema3/diecinueve')}
            >
...
const styles = StyleSheet.create({
  ...
  option: {
    ...
    borderRadius: 20,
    marginBottom: 15,
    // Eliminamos sombras pesadas para un look más limpio y responsivo
    elevation: 0, 
  },
  optionText: {
    fontSize: 17,
